...
$.ajax(settings).done(function (response) {
    ...
    $("#platforms").append(response.results[0].locations[0].display_name);
    $("#platforms").append(response.results[0].locations[1].display_name);
    $("#platforms").append(response.results[0].locations[2].display_name);
const movieInp = document.getElementById("search-bar");
const searchButn = document.getElementById("searchBtn");
const searchInp = movieInp.value;
